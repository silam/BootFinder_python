...
i = 0
input = 'F:\\AIImages\\input-03-14'

with open('F:\\AIImages\\AI db7.txt', 'r', encoding='utf-8') as fp:
    ...
    for line in contents:
        ...
        print("Not garment")
        if "glove" in catalog.lower(): continue
        print("Not Glove")

        if "sock" in catalog.lower(): continue
        print("Not sock")


        if "<unit>pr</unit>" in catalog.lower():
            print("PR")
        else:
            print("NO PR")
            continue

        if "<image" in catalog.lower():

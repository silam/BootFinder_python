...
ENDPOINT = "https://rwsbootsfinder.cognitiveservices.azure.com/" #os.environ["VISION_TRAINING_ENDPOINT"]
training_key = "62648b8c0ba743d4a333077ba3eefc43" #os.environ["VISION_TRAINING_KEY"]
...
project_name = 'rwsbootsfinder'## + str(uuid.uuid4())
projectId ='ba03a6a2-9705-47a7-8f40-b885ce4dbcaa' #'e777e3e4-2ae3-4d03-9fb3-1f5e0925d72b'# 'b5728b98-c8aa-46c2-a394-97955008482f'  #'ba98e468-4593-45b8-99cf-8bd5df00dd62' #9a4434c4-cd29-493f-9b6e-8bc25be9e6a7'
...
arrInputDir  = os.listdir('F:\\AIImages\\RWSBootWithbackground')
